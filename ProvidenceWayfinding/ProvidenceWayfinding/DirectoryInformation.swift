...
let directory = [
    ...
    Directory(name: "BEST", category: "Children's Hospital", floor: "2", hours: "8:30 to 4:30 M-F", ext: 0),
    ...
    Directory(name: "Careshop", category: "Women's Health Center", floor: "Main West", hours: "9AM to 5PM M-F, 11AM to 3PM Sat", ext: 44040),
    ...
    Directory(name: "Emergency Department", category: "Main Tower", floor: "L1", hours: "12AM to 12AM", ext: 43344),
    Directory(name: "Gift Shop", category: "Main Tower", floor: "Main", hours: "9:30AM to 5:30PM M-T, 7AM to7:30PM F, 10:30AM to 5PM weekends", ext: 43285),
    ...
    Directory(name: "Main Floor Back Entrance Information", category: "Main Tower", floor: "1", hours: "9AM to 5PM", ext: 43226),
    Directory(name: "Maternal-Fetal Medicine", category: "Women's Health Center", floor: "Main", hours: "8AM to 5PM", ext: 44060),
    Directory(name: "Maternity Clinic", category: "Women's Health Center", floor: "Main", hours: "8:30AM to 5PM M-T, 8:30AM to 12:30PM F", ext: 43170),
    Directory(name: "Mother-Baby Unit", category: "Women's Health Center", floor: "2 East", hours: "6AM to 10PM", ext: 42400),
    Directory(name: "Neonatal Intensive Care Unit", category: "Women's Health Center", floor: "3", hours: "9AM to 5PM", ext: 46300),
    Directory(name: "Neurology", category: "Main Tower", floor: "8", hours: "9AM to 5PM M-F", ext: 44644),
    Directory(name: "Northwest Heart and Lung", category: "Heart Institute", floor: "Main", hours: "9AM to 5PM", ext: 4560262),
    ...
    Directory(name: "Pediatrics", category: "Main Tower", floor: "3", hours: "9AM to 5PM", ext: 0),
    Directory(name: "Pediatric Emergency", category: "Main Tower", floor: "L1", hours: "12AM to 12AM", ext: 45690),
    ...
    Directory(name: "Spokane Cardiology", category: "Heart Institute", floor: "4", hours: "9AM to 5PM", ext: 4558820),
    Directory(name: "Surgery", category: "Women's Health Center", floor: "Main", hours: "9AM to 5PM", ext: 44686),
    Directory(name: "Thomas Hammer Coffee (Cafeteria)", category: "Main Tower", floor: "L3", hours: "9AM to 5PM", ext: 44809),
    Directory(name: "Thomas Hammer Coffee (Emergency)", category: "Main Tower", floor: "L1", hours: "9AM to 5PM", ext: 45839),
